...
export namespace nodeUtils {
  ...
  export async function setTrustScore(apiKey: string, userHash: string, network: Network = 'mainnet', api?: string) {
    ...
    try {
      ...
      throw getErrorMessage(error, 'Error setting trust score at trust score node', 'errorMessage');
    }
  }
  ...
  export async function updateUserType(apiKey: string, userHash: string, network: Network = 'mainnet', userType: UserType, api?: string) {
    ...
    try {
      ...
      throw getErrorMessage(error, 'Error update user type at trust score node', 'errorMessage');
    }
  }
  ...
  export async function getUserTokenCurrencies(userHash: string, indexedWallet: Wallet, api?: string, network: Network = 'mainnet') {
    ...
    try {
      ...
      throw getErrorMessage(error, 'Error get user token currencies', 'errorMessage');
    }
  }
  ...
  export async function getTokenDetails(currencyHash: string, userHash: string, indexedWallet: Wallet, api?: string, network: Network = 'mainnet') {
    ...
    try {
      ...
      throw getErrorMessage(error, 'Error get user token details', 'errorMessage');
    }
  }
  ...
  export async function getTokenDetailsBySymbol(currencySymbol: string, userHash: string, indexedWallet: Wallet, api?: string, network: Network = 'mainnet') {
    ...
    try {
      ...
      throw getErrorMessage(error, 'Error get user token details by symbol', 'errorMessage');
    }
  }
